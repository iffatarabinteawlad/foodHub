...
?>
    ...
    <div class="paragraph1">
     <h1>FOOD Hub - Good Food is Good Mood</h1>
    <p><br> 
      <h4>
      Food Hub will help in making your quest for enjoying good lunch, dinner which is are home delivered all the more interesting and excited when you are scartching your head to entertain your guest with their demands met.
      </h4>
    </p>
    <p>
      <h4>
        There are two ways you can <strong>order food online</strong></font> with us. 
      </h4>
    </p>
    </div>
